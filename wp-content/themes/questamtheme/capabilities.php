...
$outer_tabs .= '<a class="nav-link '.$outer_tab_active.'" id="'.$$home_tab.'" data-toggle="pill" href="#v-pill-in-'.$heading_slug.'" role="tab" aria-controls="v-pills-'.$heading_slug.'" aria-selected="'.$aria_selected.'">'.$tab['title'].'</a>';

$outer_tabs_images .= '<div class="tab-pane fade '.$outer_tab_show.'" id="v-pill-in-'.$heading_slug.'" role="tabpanel" aria-labelledby="v-pills-'.$heading.'-tab">';
