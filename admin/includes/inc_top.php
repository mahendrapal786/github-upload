...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo DOCBASE.ADMIN_FOLDER; ?>/"><?php echo SITE_TITLE; ?><span class="hidden-xs"> |CMS BY SME</span></a>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
     ...
     <?php } else   if($_SESSION['user']['type']=='manager'){ ?>
     <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            <li>
                <a href="<?php echo DOCBASE.ADMIN_FOLDER; ?>/"<?php if(strpos($_SERVER['SCRIPT_NAME'], ADMIN_FOLDER."/index.php") !== false) echo " class=\"active\""; ?>>
            ...
            <li>
                <a href="<?php echo DOCBASE.ADMIN_FOLDER; ?>/modules/booking/booking/index.php?view=list"<?php if(strpos($_SERVER['SCRIPT_NAME'], ADMIN_FOLDER."/index.php?view=list") !== false) echo " class=\"active\""; ?>>
                    <i class="fas fa-fw  fa-calendar-check"></i> Bookings
                </a>
            </li>
